...
public class OrderService {
    ...
    private String getStatus(Order order) {
        if (order.isDelivered()) {
            ...
            return "Delivery completed on "
                    + (DateTimeFormatter.ISO_LOCAL_DATE).format(deliveredDateTime) + " at "
            ...
            return "Dispatching completed on "
                    + (DateTimeFormatter.ISO_LOCAL_DATE).format(dispatchedDateTime) + " at "
            ...
            return "Scheduling completed on "
                    + (DateTimeFormatter.ISO_LOCAL_DATE).format(scheduleDateTime) + " at "
            ...
            return "Allocation completed on "
                    + (DateTimeFormatter.ISO_LOCAL_DATE).format(allocatedDateTime) + " at "
            ...
            return "Reservation completed on "
                    + (DateTimeFormatter.ISO_LOCAL_DATE).format(reservedDateTime) + " at "
